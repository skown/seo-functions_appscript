...
function related_searches(keyword) {
  ...
  const headers = {
    ...
    'headers': {
      "Authorization": 'Basic ' + Utilities.base64Encode('adrian.skowron@brainly.com' + ':' + '6a82d00b8f673110')
      },
      'muteHttpExceptions': true,
      "payload": JSON.stringify([{'keyword': keyword, 'language_code': 'pt', 'location_code': 2076}])
  }
